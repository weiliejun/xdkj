...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    public Map<String, String> login(String userName, String password, String ip, String sid, String exitVerifyCode, String validateCode) {
        ...
        Integer passwordErrorCount = cacheService.getObject(passwordErrorCountKey);
    ...
    public void saveSession(String sid, SessionUser sessionUser) {
        ...
        //根据sid查询原有的uid
        String oldUid = cacheService.get(RedisUtil.keyBuilder(RedisEnum.USER_LOGIN_SESSION, sid, "uid"));
        //判断key是否存在，若存在就删除
        ...
        cacheService.remove(RedisUtil.keyBuilder(RedisEnum.USER_LOGIN_SESSION, sid, "uid"));
        ...
        cacheService.set(RedisUtil.keyBuilder(RedisEnum.USER_LOGIN_SESSION, sid, "uid"), String.valueOf(uid), SESSION_INVALID_TIME);
