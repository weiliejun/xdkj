...
BizQQWPA.set("srcPath", "/crm/wpa/release/3.3.3/");
BizQQWPA.setVersion("3.3.20140708");
// 加qq服务 命名控件id以bizQQ_WPA_ 开头
$(function(){
	var qqids=$("[id*='bizQQ_WPA_']");
	for(i=0;i<qqids.length;i++){
		var id=$(qqids[i]).attr("id");
		BizQQWPA.addCustom({
			aty: '0',
			a: '1001',
			nameAccount: '4000669355',
			selector: id
		});
		
		//$(qqids[i]).attr("target","_blank");
		//$(qqids[i]).attr("href","http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODAwOTAzM180MjU1NzVfNDAwMDU3ODg1NV8yXw");
	}
	// BizQQWPA.visitor({nameAccount: '4000669355'});
});
