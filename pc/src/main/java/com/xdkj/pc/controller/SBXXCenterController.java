...
public class SBXXCenterController extends AbstractBaseController {
    @Autowired
     ...
     * @return
     */
    @RequestMapping("/sbxxCenter/{serviceType}")
    public String sbxxCenterIndex(HttpServletRequest request, Model model, @PathVariable String serviceType) {
        // 查询  服务信息
        ServiceInfo serviceInfo = mbigerService.getServiceInfoByCode(serviceType);
        model.addAttribute("serviceInfo", serviceInfo);
        model.addAttribute("serviceType", serviceType);
        return "userAccount/sbxxCenter/consulting";
    }
