...
public class SBZNCenterController extends AbstractBaseController {
    @Autowired
     ...
     * @return
     */
    @RequestMapping("/sbznCenter/{serviceType}")
    public String sbznCenterIndex(HttpServletRequest request, Model model, @PathVariable String serviceType) {
        // 查询  服务信息
        ServiceInfo serviceInfo = mbigerService.getServiceInfoByCode(serviceType);
        model.addAttribute("serviceInfo", serviceInfo);
        model.addAttribute("serviceType", serviceType);
        return "userAccount/sbznCenter/consulting";
    }
