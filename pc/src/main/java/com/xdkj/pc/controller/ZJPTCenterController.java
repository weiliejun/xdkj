...
public class ZJPTCenterController extends AbstractBaseController {
    @Autowired
     ...
     * @return
     */
    @RequestMapping("/zjptCenter/{serviceType}")
    public String zjptCenterIndex(HttpServletRequest request, Model model, @PathVariable String serviceType) {
        // 查询  服务信息
        ServiceInfo serviceInfo = mbigerService.getServiceInfoByCode(serviceType);
        model.addAttribute("serviceInfo", serviceInfo);
        model.addAttribute("serviceType", serviceType);
        return "userAccount/zjptCenter/consulting";
    }
