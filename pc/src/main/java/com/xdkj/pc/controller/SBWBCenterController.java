...
public class SBWBCenterController extends AbstractBaseController {
    @Autowired
     ...
     * @return
     */
    @RequestMapping("/sbwbCenter/{serviceType}")
    public String sbwbCenterIndex(HttpServletRequest request, Model model, @PathVariable String serviceType) {
        // 查询  服务信息
        ServiceInfo serviceInfo = mbigerService.getServiceInfoByCode(serviceType);
        model.addAttribute("serviceInfo", serviceInfo);
        model.addAttribute("serviceType", serviceType);
        return "userAccount/sbwbCenter/consulting";
    }
