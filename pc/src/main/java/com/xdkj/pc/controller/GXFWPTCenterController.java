...
public class GXFWPTCenterController extends AbstractBaseController {
    @Autowired
     ...
     * @return
     */
    @RequestMapping("/gxfwptCenter/{serviceType}")
    public String gxfwptCenterIndex(HttpServletRequest request, Model model, @PathVariable String serviceType) {
        // 查询  服务信息
        ServiceInfo serviceInfo = mbigerService.getServiceInfoByCode(serviceType);
        model.addAttribute("serviceInfo", serviceInfo);
        model.addAttribute("serviceType", serviceType);
        return "userAccount/gxfwptCenter/consulting";
    }
